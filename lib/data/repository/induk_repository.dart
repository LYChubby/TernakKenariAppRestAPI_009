...
import 'package:canary_template/data/models/request/admin/induk_request_model.dart';
import 'package:canary_template/data/models/response/get_all_induk_response.dart';
...
class IndukRepository {
  ...
  Future<Either<String, GetIndukById>> addInduk(
    ...
    try {
      ...
      return Left('An error occurred while adding the induk: $e');
    }
  }
  ...
  Future<Either<String, GetAllIndukModel>> getAllInduk() async {
    try {
      ...
      return Left('An error occurred while fetching all induk: $e');
    }
  }
}
